...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const MULTICALL_ABI = [
      ...
      'function getAuction(address account) external view returns (tuple(uint16 epochId, uint192 initPrice, uint40 startTime, address paymentToken, uint256 price, uint256 paymentTokenPrice, uint256 wethAccumulated, uint256 wethBalance, uint256 paymentTokenBalance))' // <- CORRECTED ABI STRUCT
    ];
