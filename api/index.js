module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Use PUBLIC_URL as the launch URL for the mini-app itself
    ...
    // MODIFIED: Change action type from 'launch_frame' to 'link' to open the miniapp directly
    const miniAppEmbed = {
      version: "1",
      ...
      button: {
        ...
        action: {
          ...
          url: `${PUBLIC_URL}`, // <-- CHANGED to point to the base URL (index.html)
